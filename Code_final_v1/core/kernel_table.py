"""Tabulation of Ibar2(t,s;k) (and I1,I2 separately) for kernel export.
The WKB continuation's non-oscillatory integrals y(eta)=int f1,
z(eta)=int sqrt(f3) are background-only, solved once globally
(`BackgroundTables`) and reused for every scalar leg.
"""
import numpy as np
